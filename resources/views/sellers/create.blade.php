        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Add seller</div>

                    <div class="panel-body">
                        {!!  Form::open(array('url' => '/sellers/', 'method' => 'POST', 'class' => 'form-horizontal')) !!}
                        {{ csrf_field() }}
                            ...
                            <div class="col-md-6">
                                <select id="zip_code_id" name="zip_code_id">
                                    @foreach($zip_codes as $zip_code)
                                        @if ($zip_code->id === old('zip_code_id'))
                        ...
                        <div class="form-group{{ $errors->has('active') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="active" type="radio" name="active" value="1" @if(old('active')) checked @endif>Yes<br>
                                <input type="radio" name="active" value="0" @if(!old('active')) checked @endif>No<br>
